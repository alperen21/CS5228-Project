...
summary_df_file = "online_1000_ids_summary.csv"
num_appids_to_collect = 1000
...
def main():
    ...
    df_all_summaries = pd.read_csv(summary_df_file)
    ...
    print(
        f"steam_{appid_num_to_get}_ids_tokenized_summary_reviews.csv is complete!\n"
    )
